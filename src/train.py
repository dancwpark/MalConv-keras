...
parser.add_argument('--max_len', type=int, default=2000, help="model input legnth")
parser.add_argument('--win_size', type=int, default=5)
parser.add_argument('--val_size', type=float, default=0.05, help="validation percentage")
